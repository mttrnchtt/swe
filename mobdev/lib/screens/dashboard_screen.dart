...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  final List<Map<String, String>> allProducts = [
    ...
    },
    {
      ...
      'image': 'assets/images/blueberry.jpg', // Replace with actual paths
    },
    {
      ...
      'farm': 'Kokshetau',
      'availability': 'In stock',
      'image': 'assets/images/wheat.jpg', // Replace with actual paths
    },
  ];
        ...
        onTap: (index) {
          ...
          if (index == 0) {
            ...
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => ProfilePage(role: role), // send role
              ),
            );
          }
        },
